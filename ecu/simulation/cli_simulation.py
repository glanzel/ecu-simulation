...
Die eigentliche Simulationslogik liegt im Modul ``ecu.simulation.simulation``.
"""
...
from ecu.simulation.report_aggregates import group_results_by_calendar_year
from ecu.simulation.run_params import RunParams
from ecu.simulation.simulation import PeriodResult, run_simulation
